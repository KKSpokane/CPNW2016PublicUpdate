...
<!--
<p>
          This dashboard area is where you will find all the information you need to complete all the requirements related to your clinical learning experience.
        </p>
        <p>
          The requirements are listed under the clinical prerequesites tab on the left. You must complete all the steps on the Health + Safety and elearning tabs.
        </p>
        <p>
          In the My Account tab you will find your profile and security information which you may update as needed.
        </p>
